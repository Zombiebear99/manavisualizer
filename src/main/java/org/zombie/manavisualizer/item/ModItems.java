...
import org.zombie.manavisualizer.item.custom.ManaReaderItem;
...
public class ModItems {
    ...
    public static final RegistryObject<Item> MANAREADER = ITEMS.register("manareader",
            () -> new ManaReaderItem(new Item.Properties().stacksTo(1).tab(ModCreativeModeTab.MANAVISUALIZER_TAB)));
